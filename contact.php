...
<body class="bg-white" data-bs-theme="dark">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-white position-sticky top-0">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav me-auto mb-2 mb-lg-0 mx-auto text-center">
                                <li class="nav-item">
                                    <a class="nav-link " aria-current="page" href="index.php"><span><i class="fa-solid fa-house"></i></span>Home</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="about.php"><span><i class="fa-solid fa-circle-info"></i></span>About</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="services.php"><span><i class="fa-solid fa-screwdriver-wrench"></i></span>Services</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="product.php"><span><i class="fa-solid fa-cart-shopping"></i></span>Product</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link active-link" href="contact.php"><span><i class="fa-solid fa-square-phone"></i></span>Contact</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-2">
                        <div class="justify-content-between align-items-center" style="position: relative; top: 8px;">
                            <p class="text-white text-center rounded-pill p-1 px-3" style="background: #000000;"><i class="bi bi-telephone-fill"></i> +91 8788276872</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container-fluid">
        <div class="row pb-3 mt-5 bg-white d-flex justify-content-evenly">
        ...
        <div class="row justify-content-evenly mt-5">
            <div class="col-lg-5 bg-white shadow py-3">
                <form action="connection.php" method="post">
                    ...
                    <div class="mb-3">
                        <label for="exampleFormControlTextarea1 flot" class="form-label text-dark">Message</label>
