...
<body style="background-color: #ffffff;" data-bs-theme="dark">
                    ...
                    <div class="col-lg-3">
                        <div class="d-flex cartcntt3" id="cartcntt">
                            ...
                            if (isset($_SESSION['logged_in']) && $_SESSION['logged_in'] == true) {
                                ...
                                echo "
                                    <div class='justify-content-between align-items-center' id='expp'>
                                        <button class='rounded' id='signupp1' onclick=\"document.getElementById('id01').style.display='block'\" style='width:auto; margin-right:10px'>Login</button>
                                        <button class='rounded' id='signupp2' onclick=\"document.getElementById('id05').style.display='block'\" style='width:auto;'>Register</button>
                                    </div>
                                ";
                            }
                            ?>
    ...
    <!-- <div class="container-fluid mt-5 mb-5 bg-white">
        <div class="container border" style="padding: 100px; border-radius: 10px">
            <div class="row">
                <div class="col-lg-12 text-center d-flex justify-content-center">
                    <ul style=" list-style: none; display: flex; margin: 0; padding: 0; width: 45%; align-items: center; justify-content: space-evenly;">
                        <li>
                            <a id="parachangehover" style="text-decoration: none;" href="index.php">
                                <p style="font-size: 14px;">Home</p>
                            </a>
                        </li>

                        <li>
                            <a id="parachangehover" style="text-decoration: none;" href="about.php">
                                <p style="font-size: 14px;">About Us</p>
                            </a>
                        </li>
                        <li>
                            <a id="parachangehover" style="text-decoration: none;" href="services.php">
                                <p style="font-size: 14px;">Services</p>
                            </a>
                        </li>
                        <li>
                            <a id="parachangehover" style="text-decoration: none;" href="contact.php">
            ...
            <div class="row justify-content-center" style="padding: 23px;">
                <div class="col-lg-12" style=" display: flex;
                                               align-items: center;
                                               justify-content: space-between;
                                                width: 29%;">
                    <a id="changehoverfooter" href="https://wa.me/919356562998" target="_blank"><i class="bi bi-whatsapp mx-1"></i></a>
                    <i id="changehoverfooter" class="bi bi-facebook mx-1"></i>
                    <i id="changehoverfooter" class="bi bi-twitter mx-1"></i>
                    <a id="changehoverfooter" style="text-decoration: none;" href="mailto:suraj.vishwakarma5708@gmail.com"><i class="bi bi-envelope mx-1"></i></a>
                </div>
            </div>
            <div class="row">
                <div class="col-g-12 text-center">
                    <p style="color: #7a7a7a; font-family: sans-serif; font-size:12px;" id="foot">© 2023 Vishwakarma-Architect. All Rights Reserved | Design by Suraj Vishwakarma</p>
                </div>
            </div>
        </div>
    </div> -->
