...
<body class="bg-white" data-bs-theme="dark">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark position-sticky top-0" style="background-color: #ffffff;">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav me-auto mb-2 mb-lg-0 mx-auto text-center">
                                <li class="nav-item" id="zzr">
                                    <a class="nav-link active-link text-dark" aria-current="page" href="index.php"><span><i class="fa-solid fa-house"></i></span>Home</a>
                                </li>
                                <li class="nav-item" id="zzr">
                                ...
                                echo "
                                    ...
                                    <button class='rounded btn-sm' id='signupp1' onclick=\"document.getElementById('id01').style.display='block'\" >Login</button>
                                        ...
                                        <a href='mycart.php' id='inboxbadge'>
                                            <button type='button' class='btn position-relative shadow-none text-white m-2' style='background-color: #000000; padding: 4px 8px; border-radius: 50%;'>
                        ...
                        <div class="container" id="modul">
                            ...
                            <form class="modal-content border-0" action="login_register.php" method="POST">
                                <div class="mb-3">
                                    ...
                                    <input required type="text" name="email_username" value="<?php echo $id ?>" class="form-control shadow-none" id="exampleInputEmail1" aria-describedby="emailHelp">
                                </div>
                                <div class="mb-3">
                                    <label for="exampleInputPassword1" class="form-label">Password</label>
                                    <input required type="password" name="password" value="<?php echo $pass ?>" class="form-control shadow-none" id="exampleInputPassword1">
                                </div>
    ...
    <div class="container-fluid">
        ...
        <div class="container">
            ...
            <div class="row justify-content-evenly mt-5" id="over">
                <div class="card bg-white border-0 foothover" style="width: 190px;">
                ...
                <div class="card bg-white border-0 foothover hid" style="width: 190px;">
                    <img src="images/wood5.webp" class="card img-fluid mb-3" style="height: 231px;">
