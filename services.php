...
<body data-bs-theme="dark" class="lp">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark position-sticky top-0" style="padding: 12px;">
                ...
                <div class="row">
                    ...
                    <div style="width: fit-content;" class="col-lg-3 collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0 mx-auto text-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active-link" href="services.php"><span><i class="fa-solid fa-screwdriver-wrench"></i></span>Services</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="product.php"><span><i class="fa-solid fa-cart-shopping"></i></span>Product</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="contact.php"><span><i class="fa-solid fa-square-phone"></i></span>Contact</a>
                            </li>
                        </ul>
                    </div>
