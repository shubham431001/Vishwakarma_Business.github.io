...
if (isset($_POST['login'])) {
    $query = "SELECT * FROM `registered_usersss` WHERE `email`='$_POST[email_username]' OR `username`='$_POST[email_username]'";
...
if (isset($_POST['register'])) {
    $user_exist_query = "SELECT * FROM `registered_usersss` WHERE `username`='$_POST[username]' OR `email`='$_POST[email]'";
    ...
    if ($result) {
        ...
        } else #it will be executed if no one has taken username or email before.
        {
            ...
            $query = "INSERT INTO `registered_usersss` (`full_name`, `username`, `email`, `password`,`verification_code`, `is_verified`) VALUES ('$_POST[full_name]','$_POST[username]','$_POST[email]','$password','$v_code','0')";
