...
if (isset($_POST['checkout'])) {
    ...
    $sql = "INSERT INTO `bill_checkouts`(`fnbill`, `e_mails`, `addresses`, `city`, `state`, `pin_code`) VALUES ('$_POST[fnbill]','$_POST[e_mails]','$_POST[addresses]','$_POST[city]','$_POST[state]','$_POST[pin_code]')";
